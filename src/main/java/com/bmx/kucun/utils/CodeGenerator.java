...
public class CodeGenerator {
    ...
    // 数据库连接配置
    private static final String JDBC_URL = "jdbc:mysql://192.168.31.11:3306/meisui_mall?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&useSSL=false&allowPublicKeyRetrieval=true";
    private static final String JDBC_USER_NAME = "root";
    private static final String JDBC_PASSOWRD = "rootabc123";

    // 包名和模块名
    private static final String PACKAGE_NAME = "com.bmx";
    private static final String MODULE_NAME = "kucun";

    // 表名，需要自动生成代码的表， 多个表使用英文逗号分割
    private static final String[] TBL_NAMES = { "roles","shops","goods","imgs","approve" };
